 ...
 */
public class SwipeCardLinearLayout extends LinearLayout {
    ...
    public SwipeCardLinearLayout(Context context) {
        super(context);
        setClipChildren(false);
    }

    public SwipeCardLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        setClipChildren(false);
    }

    public SwipeCardLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        setClipChildren(false);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public SwipeCardLinearLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
